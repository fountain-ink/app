...
export const metadata: Metadata = {
  ...
  description:
    "Fountain is a serene escape for writers and readers, a return to mindful engagement and authentic connection.",
};
    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl mx-auto">
      <div className={proseClasses}>
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            No overwhelming feeds and aggressive ads that plague traditional media. Here, reading becomes a mindful act.
            Comments from people you follow are seamlessly integrated, adding layers of insight and connection without
          ...
          <p>
            ...
            and celebrated. High-quality content is highlighted, and exceptional contributions are recognised and
            rewarded.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Creator ownership:</strong> We help you <strong>own your content</strong>. We help you get
              rewarded directly by the people who enjoy it.
            </li>
            <li>
              <strong>Human collaboration:</strong> Writing with friends is as simple as copy-pasting the link to your
              editor.
            </li>
            <li>
              <strong>Public goods:</strong> Fountain is proudly{" "}
              <a href="https://github.com/fountain-ink" target="_blank" rel="noopener noreferrer">
                open source
              </a>{" "}
              under AGPLv3.
            </li>
            <li>
              <strong>Decentralized resilience:</strong> Built on top of{" "}
              <a href="https://lens.xyz" target="_blank" rel="noopener noreferrer">
                Lens
              </a>
              , Fountain features <strong>zero vendor lock in</strong>. All of your content is distributed across every
              Lens app, in the present and in the future.
            </li>
          </ul>
