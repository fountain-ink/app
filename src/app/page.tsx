    ...
    <>
      ...
      <main className="flex flex-col items-center max-w-md sm:max-w-lg mx-auto" id={"scroll_container"}>
        <ArticleLayout>
          ...
          <p>Because of the way Fountain is built, nobody, not even us, can take it away.</p>

          <h2>Copyrighted automatically.</h2>
          <p>All Fountain posts are timestamped and written into blockchain, with a license of your liking attached.</p>

          <h2>Earn in new ways.</h2>
          <p>We help you get rewarded directly by the people who enjoy your words.</p>

          <h2>Human collaboration.</h2>
          <p>Writing with friends is as simple as copy-pasting a link to your browser.</p>
