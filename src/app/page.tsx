      ...
      <div className="flex flex-col gap-12 px-4 py-16 mb-20 max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl">
        <div className={proseClasses}>
          ...
          <p>
            ...
            and readers alike. Fountain a serene escape, a return to mindful engagement and authentic connection. We
          ...
          <h3>Join Us</h3>
          <p>
            Join the Fountain waitlist and be part of a community that values quality over quantity, depth over breadth,
            and authenticity over superficiality.
          </p>
