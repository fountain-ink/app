...
export default function ContestWeekPage() {
  ...
  const weekItems = contests
    ...
    .sort((a, b) => {
      const aNum = Number.parseInt(a.id.replace("week-", ""));
      const bNum = Number.parseInt(b.id.replace("week-", ""));
      return aNum - bNum;
    });
          ...
          <div className="">
            <div className="xl:hidden mb-4 max-w-md">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="all-contests">All Contests</SelectItem>
                  {weekItems.map((item) => (
            ...
            <div className="pb-6 border-b">
              ...
              {contestData?.contest.theme && <p className="text-muted-foreground pl-4">{contestData.contest.theme}</p>}
            </div>
