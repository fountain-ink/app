...
export const IframeElement = withRef<typeof PlateElement>(({ children, className, ...props }, ref) => {
  ...
  return (
    <ElementPopover open={selected} showWidth={false} showCaption={false} content={editUrlPopoverContent}>
      <PlateElement
        ref={ref}
        className={cn(
          className,
        ...
        {...props}
      >
        <figure className="group relative m-0 w-full h-auto flex-1" contentEditable={false}>
          {isLoading && (
