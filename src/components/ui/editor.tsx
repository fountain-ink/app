  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default: "min-h-full px-16 pb-16 text-base sm:px-[max(64px,calc(50%-350px))]",
        demo: "h-full px-16 pb-16 pt-4 text-base sm:px-[max(64px,calc(50%-350px))]",
        fullWidth: "min-h-full px-16 pb-16 text-base sm:px-24",
