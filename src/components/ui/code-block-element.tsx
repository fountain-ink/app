  ...
  return (
    ...
    >
      <PlateElement
        ref={ref}
        className={cn(
          "relative my-8 rounded-sm flex flex-col items-center",
          className,
          "py-1",
      ...
      >
        ...
        >
          ...
          >
            <pre
              className="bg-muted px-6 py-4 text-foreground/80 font-mono text-sm not-prose leading-[normal] [tab-size:2] min-w-full"
              spellCheck="false"
            >
