...
export const ColorSelector = ({ open, onOpenChange }: { open: boolean; onOpenChange: (open: boolean) => void }) => {
    ...
    <Popover modal={true} open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="flex flex-col">
          ...
          {TEXT_COLORS.map(({ name, color }, _index) => (
            <EditorBubbleItem
              key={name}
              onSelect={() => {
        ...
        <div>
          ...
          {HIGHLIGHT_COLORS.map(({ name, color }, _index) => (
            <EditorBubbleItem
              key={name}
              onSelect={() => {
